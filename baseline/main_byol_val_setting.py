...
def train(net, train_iter, test_iter, criterion, optimizer, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % 1 == 0:
            ...
            val_writer.add_scalar('loss/val_loss', test_loss_sum / batch_count2, epoch)
            val_writer.add_scalar('accuracy/val_acc', test_acc_sum / n2, epoch)
        train_writer.add_scalar('loss/train_loss', train_loss_sum / batch_count, epoch)
        train_writer.add_scalar('accuracy/train_acc', train_acc_sum / n, epoch)
