...
parser.add_argument('--data', metavar='DIR',default="../../../../../data2/jing_data/dataset/",type=str,
...
parser.add_argument('--moco-k', default=576, type=int,
...
def main_worker(gpu, ngpus_per_node, args):
    args.gpu = gpu
    log_path=os.path.join(args.log_path,f'epoch{args.epochs}_batchsize{args.batch_size}_{args.arch}_mm{args.moco_k}')
    ...
    print(model)
##not using distributerd, different from origional code
